...
namespace CSLibrary.Data.Models
{
    ...
    public partial class MfRadbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasIndex(e => e.PointId).HasName("IX_CardEvents_PointId");

                entity.HasIndex(e => e.TypeId).HasName("IX_CardEvents_TypeId");
            ...
            modelBuilder.Entity<Qrevent>(entity =>
            {
                ...
                entity.HasIndex(e => e.PayId).HasName("IX_QREvents_PayId");

                entity.HasIndex(e => e.PointId).HasName("IX_QREvents_PointId");

                entity.HasIndex(e => e.TypeId).HasName("IX_QREvents_TypeId");
            ...
            {
                entity.HasIndex(x => x.PlaceId).HasName("IX_Users_PlaceId");
